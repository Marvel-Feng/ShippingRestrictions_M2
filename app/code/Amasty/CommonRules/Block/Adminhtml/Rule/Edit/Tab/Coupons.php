...
<span>Promotions / Shopping Cart Rules</span></a> area first.',
        ...
        $fldInfo->addField(
            ...
            [
                ...
                'note' => __(
                    'Apply this rule with ANY coupon from specified discount rule. You should configure the rule in <a href="%1"><span>Promotions / Shopping Cart Price Rules</span></a> area first. Useful when you have MULTIPLE coupons in one rule.',
                    $promoShippingRulesUrl
                ),
            ]
        );
        ...
        $fldInfo->addField(
            ...
            [
                ...
                'name' => 'coupon_disable',
                'note' => __(
                    'Not apply this rule with coupon. You should configure coupon in <a href="%1"><span>Promotions / Shopping Cart Rules</span></a> area first.',
                    $promoShippingRulesUrl
                ),
            ]
        );
        ...
        $fldInfo->addField(
            ...
            [
                ...
                'values' => $this->poolOptionProvider->getOptionsByProviderCode('sales_rules'),
                'note' => __(
                    'Not apply this rule with ANY coupon from specified discount rule. You should configure the rule in <a href="%1"><span>Promotions / Shopping Cart Price Rules</span></a> area first. Useful when you have MULTIPLE coupons in one rule.',
                    $promoShippingRulesUrl
                ),
            ]
        );
